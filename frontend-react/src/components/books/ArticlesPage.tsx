...
function ArticlesPage() {
  ...
  const debouncedSearch = useCallback(
    debounce(async (query) => {
      ...
      try {
        const data = await sendRequest<Array<BookData>>(
          `http://localhost:8081/api/books/search?knowledgeArea=${BookKnowledgeArea.Article}&query=${query}`,
          requestOptions,
          navigate,
          logout
        );
  ...
  return (
    <Flex direction={{ base: "column", md: "row" }} minH="100vh">
      ...
      <Flex direction="column" align="center" flex="1" p="4">
        ...
        <Flex justify="flex-end" width="100%" pr="4" pb="4">
